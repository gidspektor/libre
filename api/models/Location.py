...
class Location(models.Model):
  ...
  allows_own_drinks = models.BooleanField(blank=False, default=0)
  ...
  basic_sound_system = models.BooleanField(blank=False, null=True, default=0)
  professional_sound_system = models.BooleanField(blank=False, default=0)
  serves_alcohol = models.BooleanField(blank=False, default=0)
